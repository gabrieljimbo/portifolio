...
**Check for a `product-brief.md` in the project root.** If found, use it for audience, product, and conversion goal context. If not found, gather the basics from the user.
...
- **copy-editing**: If the copy needs line-by-line polish
